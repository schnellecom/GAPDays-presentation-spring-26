...
\begin{frame}
    \begin{block}{Background}
        Currently there are multiple packages, which provide functionality to visualise GAP objects.
    \end{block}
    \pause
...
\begin{frame}{SgpViz (by Manuel Delgado and José João Morais)}
    ...
    \end{exampleblock}
    \centering
    \includegraphics[width=1\textwidth]{images/sgpviz-1.png}
\end{frame}
...
\begin{frame}{graphviz (by James D. Mitchell and Matthew Pancer)}
    \begin{exampleblock}{Digraphs visualisation}
        \begin{itemize}
            \item (some work on) having Digraphs package as extension
...
\begin{frame}
    \centering
    \includegraphics[width=0.8\textwidth]{images/digraphs-2.png}
...
\begin{frame}
    \begin{exampleblock}{Advantages}
        \begin{itemize}
            \item Uses graphviz standard
            \item Structure so it can can work with other packages
            \item Highly customisable
...
\subsection{GAPic}
\begin{frame}{GAPic (by Alice C. Niemeyer and many more)}
...
\begin{frame}
    \begin{exampleblock}{Advantages}
        \begin{itemize}
            ...
            \item Results can be iterated
            \item Can use parameterised coordinates
        \end{itemize}
    \end{exampleblock}
    \begin{alertblock}{Challenges}
        \begin{itemize}
            \item Every new feature needs own GAP function
...
\begin{frame}{Questions and discussion}
    \begin{itemize}
        ...
        \item How can we provide libraries of examples?
    \end{itemize}
\end{frame}
